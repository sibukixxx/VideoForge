...
pub use project::{
    ...
    CropRect, FitMode, ImageClip, ProjectError, SoundEffectClip, SourceInfo, TextClip, Track,
    TrackKind, Transform, VideoClip, VideoProject, VideoSettings, SCHEMA_VERSION,
};
